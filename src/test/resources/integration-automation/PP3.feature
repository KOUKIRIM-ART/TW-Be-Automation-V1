...
Feature:  Appel API création Personne Physique - Données obligatoires + coordonnées de contact  + coordonnées bancaires
  ...
  Background:
    ...
    * def req1 = read('../Data/integration-automation/PP3.json')
  ...
  Scenario: Appel API création Personne Physique - Données obligatoires + coordonnées de contact  + coordonnées bancaire
